...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="{{route('home')}}">TekkonnectPro</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @guest
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item p-2">
                            <a class="nav-link btn btn-warning px-3" aria-current="page" href="{{route('register')}}">Register</a>
                        </li>
                    </ul>
                @endguest
            </div>
